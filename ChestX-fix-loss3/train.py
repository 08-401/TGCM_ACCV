...
if __name__ == '__main__':
    ...
    # modify-WHT
    parser.add_argument('--datapath', type=str, default=r'F:/WHT/CDFSSDataSet/Source domain/PASCAL VOC2012/VOCtrainval_11-May-2012/VOCdevkit')
    ...
    #                          {"params": model.module.CANet.parameters(), "lr": 1*args.lr},
    #
    #                          ]
