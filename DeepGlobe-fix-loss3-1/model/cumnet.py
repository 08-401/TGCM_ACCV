...
from assistDataSet.assistDS4ChestX import cutmixFeature4support_segmentation
...
class CuMNetwork(nn.Module):
    def __init__(self, backbone):
        ...
        # self.AANet = AA()
    def forward(self, query_img, support_img, support_mask,img2=None,mask2=None):
        ...
        with torch.no_grad():
            ...
            if img2!=None:
                ...
                assist_feats = self.extract_feats(img2, self.backbone, self.feat_ids, self.bottleneck_ids, self.lids)
                # 假如只对 Support-Set 做特征的CutMix
                support_feats,support_mask = cutmixFeature4support_segmentation(support_feats, support_mask, assist_feats, mask2, beta_factor=0.4)
                # query_feats,query_feats_old
