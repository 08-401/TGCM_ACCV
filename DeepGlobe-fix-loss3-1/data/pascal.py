...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot):
        ...
        self.img_path = os.path.join(
            r'F:/WHT/CDFSSDataSet/Source domain/PASCAL VOC2012/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/JPEGImages')
        self.ann_path = os.path.join(r'F:/WHT/CDFSSDataSet/Source domain/PASCAL VOC2012/SegmentationClassAug')
