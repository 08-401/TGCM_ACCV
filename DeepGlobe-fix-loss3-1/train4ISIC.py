...
from assistDataSet.assistDS4ISIC import cutmix4support_segmentation, randomSelect4ISIC, cutmix4query_segmentation
...
if __name__ == '__main__':
    ...
    dataloader_val = FSSDataset.build_dataloader('isic', args.bsz, args.nworker, args.fold, 'val')
