...
from assistDataSet.assistDS4FSS import cutmix4support_segmentation, randomSelect4FSS, cutmix4query_segmentation
...
def train(epoch, model, dataloader, optimizer, training):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        # if training:
        #     img2, mask2 = randomSelect4FSS()
        #     batch['support_imgs'], batch['support_masks'] = cutmix4support_segmentation(batch['support_imgs'],
        #                                                                                 batch['support_masks'], img2,
        #                                                                                 mask2,
        #                                                                                 beta_factor=0.4)
        #     batch['query_img'], batch['query_mask'] = cutmix4query_segmentation(
        #         batch['query_img'],
        #         batch['query_mask'],
        #         img2,
        #         mask2,
...
if __name__ == '__main__':
    ...
    #                          # {"params": model.module.BCPA.parameters(), "lr": args.lr},
    #                          ]
    ...
    dataloader_val = FSSDataset.build_dataloader('fss', args.bsz, args.nworker, args.fold, 'val')
