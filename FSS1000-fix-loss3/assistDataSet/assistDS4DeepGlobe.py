...
def cutmix4query_segmentation(queryImgs, queryMasks, img2, mask2, beta_factor=0.4):
    ...
    for i in range(bsz):
        ...
        queryMasks[i, cut_x:cut_x + cut_height, cut_x:cut_x + cut_width] = mask2[ cut_x:cut_x + cut_height,
                                                                                 cut_x:cut_x + cut_width]
    return queryImgs, queryMasks


imgPath = r"F:\WHT\CDFSSDataSet\AssistDataSet\DeepGlobe\Img"
maskPath = r"F:\WHT\CDFSSDataSet\AssistDataSet\DeepGlobe\Mask"


def randomSelect4DeepGlobe():
